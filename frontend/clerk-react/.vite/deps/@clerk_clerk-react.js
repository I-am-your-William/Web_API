...
var useLoadedIsomorphicClerk = (options) => {
  const isomorphicClerkRef = import_react38.default.useRef(IsomorphicClerk.getOrCreateInstance(options));
  const [clerkStatus, setClerkStatus] = import_react38.default.useState(isomorphicClerkRef.current.status);
  import_react38.default.useEffect(() => {

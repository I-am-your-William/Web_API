  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6 overflow-y-auto">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex mb-6">
          <button
            className={`px-4 py-2 rounded-t-lg border-b-2 ${activeTab === "incoming"
          ...
          <button
            className={`px-4 py-2 rounded-t-lg border-b-2 ml-2 ${activeTab === "passed"
              ? "border-blue-600 text-blue-600 font-semibold bg-white"
              : "border-transparent text-gray-500 bg-gray-200"
              }`}
            onClick={() => setActiveTab("passed")}
        ...
        {/* Add spacing between tabs and list */}
        <div className="mb-6" />
        ...
        {!bookingsToShow.length ? (
          ...
          bookingsToShow.map((booking: Booking) => (
            <div
              key={booking.bookingId}
              style={{ border: '1px solid #ccc', padding: '1rem', marginBottom: '1rem' }}
              className="border border-gray-300 rounded-xl shadow-md bg-white p-6 mb-8"
            >
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-lg font-semibold">Booking: {booking.bookingId}</h3>
